...
const resources = {
  ...
  salas: {
    ...
    columns: [
        { key: 'codigo', header: 'Código' },
        { key: 'numero_sillas', header: 'Nº Sillas' },
        { key: 'cineInfo.nombre', header: 'Cine' },
    ],
    formFields: [
        { name: 'codigo', placeholder: 'Código' },
        { name: 'numero_sillas', placeholder: 'Número de Sillas', type: 'number' },
        { name: 'cine_id', placeholder: 'Seleccionar Cine', type: 'select', options: [] },
    ],
  },
  peliculas: {
    name: 'Películas',
  ...
  funciones: {
    ...
    columns: [
        { key: 'pelicula.titulo', header: 'Película' },
        { key: 'cine.nombre', header: 'Cine' },
        { key: 'sala.codigo', header: 'Sala' },
        { key: 'fecha_hora', header: 'Fecha y Hora', type: 'datetime' },
    ],
    formFields: [
        { name: 'pelicula_id', placeholder: 'Seleccionar Película', type: 'select', options: [] },
        { name: 'cine_id', placeholder: 'Seleccionar Cine', type: 'select', options: [] },
        { name: 'sala_id', placeholder: 'Seleccionar Sala', type: 'select', options: [] },
        { name: 'fecha_hora', placeholder: 'Fecha y Hora', type: 'datetime-local' },
    ],
  },
  users: {
    name: 'Usuarios',
